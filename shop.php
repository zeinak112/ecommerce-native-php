...
$resultcat= $con -> query($selectcat);
while ($categories = $resultcat -> fetch_assoc()) {
    ?>
 <!--  Catagories  -->
                            <div class="catagories-menu">
                                <ul id="menu-content2" class="menu-content collapse show">
                                       <!-- Single Item -->
                                        ...
                                        <a href="shop.php?categoriesid=<?=$categories['id']?>"><?=$categories['name']?></a>
                               </ul>
                            </div>
                ...
                <div class="col-12 col-md-8 col-lg-9">
                  ...
                  <div class="row">
                   ...
                   if (isset($_GET['categoriesid'])) {
                    $categories_id=$_GET['categoriesid'];
                   $select = "SELECT * FROM products WHERE categories ='$categories_id'";
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-wrapper">
                                    ...
                                    <div class="product-description">
                                        ...
                                        <p class="product-price"><span class="old-price"></span><?=$row['price']?> </p>
                    ...
                    <div class="single_widget_area d-flex mb-30">
                        ...
                        <div class="footer_menu">
                            <ul>
                                ...
                                <li><a href="cut/checkout.php">Checkout</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
